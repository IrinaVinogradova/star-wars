    ...
    return (
        <form className={`w-4/5 my-0 mx-auto rounded-[5px] bg-[#f2f2f2] p-5`} onSubmit={e => {
            ...
            <label className={`w-full text-red-color`}>First Name
                <input className={`border w-full p-3 border-[#ccc] rounded-[4px] mt-1.5 mb-4 resize-y`} type="text" name="firstname" placeholder="Your name.."/>
            </label>
            <label>Last Name
                <input className={`border w-full p-3 border-[#ccc] rounded-[4px] mt-1.5 mb-4 resize-y`} type="text" name="lastname" placeholder="Your last name.."/>
            </label>
            ...
            <label className={`w-full text-red-color`}>Subject
                <textarea className={`border h-52 w-full p-3 border-[#ccc] rounded-[4px] mt-1.5 mb-4 resize-y`} name="subject" placeholder="Write something.."></textarea>
            </label>
            <button className={`bg-[#4CAF50] text-white py-3 border-none rounded-[4px] cursor-pointer `} type="submit">Submit</button>
        </form>
    )
}
